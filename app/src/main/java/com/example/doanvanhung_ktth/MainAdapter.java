package com.example.doanvanhung_ktth;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    String url = "https://5fd65569ea55c40016041ef5.mockapi.io/User";
    ...
    private ArrayList<User> getAllUser(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, "https://5fd65569ea55c40016041ef5.mockapi.io/User", null, new Response.Listener<JSONArray>() {
            @Override
